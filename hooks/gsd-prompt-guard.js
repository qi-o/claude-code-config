#!/usr/bin/env node
// gsd-hook-version: 1.36.0-extracted
...
//
// Source: https://github.com/gsd-build/get-shit-done v1.36.0
// Extracted for standalone use with OMC — no GSD runtime dependency
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    // Check for suspicious invisible Unicode (narrowed to zero-width chars only)
    if (/[\u200B-\u200D\uFEFF]/.test(content)) {
